...
```{r 08a_plot_trajectory_UMAP, fig.height=3, fig.width=6}
...
```{r 08b_spatial_trajectory_tissue, fig.height=8, fig.width=7}
####################
# SPATIAL DISTANCE #
####################
...
```{r 08d_clus_dotplot, fig.height=5, fig.width=(1.2*5)+1}
