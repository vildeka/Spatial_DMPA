...
saveRDS(DATA_st, paste0(result_dir,"seuratObj_deconvolution_filt.RDS"))
...
#colours <-ColourPalleteMulti(TRA_TRAB[["BEA19P035_KB_94_S16"]], "TRV", "V_region")
colours <-ColourPalleteMulti(CVLv3, "Genus", "Species")
colours <-ColourPalleteMulti(CVLv3, "Family", "Species")
colours <-ColourPalleteMulti(CVLv3, "Phylum", "Species")
colours <-ColourPalleteMulti(CVLv3, "Family", "Genus")


pal <- c(RColorBrewer::brewer.pal(9,"Set1"),RColorBrewer::brewer.pal(8,"Set2"),
         RColorBrewer::brewer.pal(9,"Pastel1"),RColorBrewer::brewer.pal(8,"Pastel2")) #color pallete for plots
pal <- c(pal, "#FFD9D0", "#FFE3AA")
...
annot2 <- c("fibroblasts","fibroblasts","T-cell","T-cell","T-cell","T-cell","T-cell","T-cell","T-cell","fibroblasts","T-cell","NA","NA","T-cell","fibroblasts","fibroblasts","myeloid","NA","myeloid","NA","NA","NA","NA","NA","T-cell","B cell","NA","T-cell","NA") %>% set_names(., seq_along(.))
...
ggplot(decon_column, aes(fill=decon_clus, y=values, x=ID)) + 
    geom_bar(position="stack", stat="identity") +
