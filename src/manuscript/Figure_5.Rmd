...
system2(command = "sed", stdout = TRUE,
        args = c("-i", "''","-e", 's/src=\\"\\./src=\\"\\.\\./g',
                 paste0("./md_files/", basename("./Figure_5.md"))))
...
```{r 05a_volcano_plot, fig.width=6.7, fig.height=3.2}
...
```{r 05b_venn_diagram, fig.width=3.4, fig.height=3.2}
#######################
# PLOTS VENN DIAGRAM #
######################
ord <-  c("Superficial","Upper IM","Lower IM","Basal", "8","3","4","0","2","1")
...
```{r 05c_dotplot_gene_traject, fig.width = 6.7, fig.height = 3.2}
###############
# FILTER DATA #
###############
DAT <- DATA %>%
...
```{r Figure-5, fig.width = 6.7, fig.height = 6.7, dpi = 1000}
#############################
# COMBINE ALL FIGURE PANELS #
#############################
# dev.new(width=6.7, height=6.7, noRStudioGD = TRUE)
Figure5 <- plot_grid( A_B, C, ncol=1, rel_heights = c(1,1)) 
ggsave("./Figures/Figure-5.pdf", Figure5, width = 6.7, height = 6.7, bg = "white", dpi = 1000)
