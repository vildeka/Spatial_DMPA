...
(A_B <- plot_grid(A, NULL, rel_widths = c(1,1), labels = c('A', 'B')) )
```
...
C <- plot_grid( C_1, C_2, ncol=1, rel_heights = c(3,1.1), labels = c('C'))
...
ggsave("./Figures/05/Figure05.png", Figure5, width = 6.7, height = 6.7, bg = "white", dpi = 300)
```