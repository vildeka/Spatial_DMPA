...
system2(command = "sed", stdout = TRUE,
        args = c("-i", "''","-e", 's/src=\\"\\./src=\\"\\.\\./g',
                 paste0("./md_files/", basename("./03_figures.md"))))

# kniter
knit_html_with_job(out_dir = "../lab_book/figure_03", fig_path = "./Figures/03/")
```
...
```{r 03a_plot_resolution, fig.width=1.3, fig.height=1.9}
# fig.asp=5/10,
###############
# FILTER DATA #
###############
...
```{r 03b_spatial_trajectory_tissue, fig.width=2.6, fig.height=1.9}
####################
# SPATIAL DISTANCE #
####################
...
```{r 03ab_UMAP_tissue, fig.width=3.35, fig.height=1.9}
...
```{r 03c_dot_and_tissue, fig.width=3.54, fig.height=3.2}
###############
# FILTER DATA #
###############
keep <- "Basal|Upper IM|Lower IM|Superficial"
...
```{r 03abc_combined, fig.width=3.4, fig.height=1.9+3}
...
```{r 03d_marker_genes_epi, fig.height=2, fig.width=3.4}
###################################
...
```{r Figure-3, fig.width=3.54, fig.height=6.7, dpi=1000}
#############################
