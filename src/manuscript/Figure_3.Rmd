...
C_1 <- wrap_plots(dot_fig, ncol = 4, guides = "collect" ) + 
  ...
  theme(#legend.position = c(.1, 1.15), legend.direction = "horizontal",
        ...
        legend.box.margin=margin(1,1,-5,0), # moves the legend
...
(D <- DATA %>%
    ...
    theme(legend.position="bottom") + guides(fill = guide_colourbar(barwidth = 5, barheight = .5),
                                             size = guide_legend(override.aes = list(size=3), keyheight = 1, keywidth = .1)
                                             ) +# horizontal
...
ggsave("./Figures/03/Figure03.png", Figure3, width = 3.54, height = 6.7, bg = "white", dpi = 300)
```