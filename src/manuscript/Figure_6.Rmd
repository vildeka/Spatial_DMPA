...
system2(command = "sed", stdout = TRUE,
        args = c("-i", "''","-e", 's/src=\\"\\./src=\\"\\.\\./g',
                 paste0("./md_files/", basename("./06_figures.md"))))
...
```{r 05ac_volcano_plot_IHC, fig.width=6.7, fig.height=3.2}
...
```{r 05b_dotplot_and_tissue_plot, fig.width = 6.7, fig.height = 3.2}
###############
# FILTER DATA #
###############
keep <- "^5|8|3|^0"
...
```{r Figure-6, fig.width = 6.7, fig.height = 6.7, dpi = 1000}
#############################
