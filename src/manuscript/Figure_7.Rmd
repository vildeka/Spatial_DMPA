...
meta_dt <- umap_obj_Tassos %>% 
  ...
  mutate(st_group = ifelse(grepl("P114|P107", .$ID), "DMPA high", 
                         ifelse(grepl("P097|P108", .$ID), "DMPA low",
                                ifelse(grepl("P031|P105|P118|P080", .$ID), "ST ctrl", .$group))) ) %>%
...
ggsave("./Figures/07/Figure07.png", Figure7, width = 7.48, height = 7.48, bg = "white", dpi = 400)
```