...
```{r Marker_genes, fig.height=3, fig.width=8}
###################################
...
ggsave("./Figures/04/Fig_04C.png", C_1, width = 6.7, height = 2.4) #, dpi = 300
```
...
ggsave("./Figures/04/Figure04.png", Figure4, width = 7.4, height = 4.8, bg = "white", dpi = 300)
```
