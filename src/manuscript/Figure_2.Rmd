...
# kniter
knit_html_with_job(out_dir = "../../lab_book/figure_02", fig_path = "./Figures/FIGURES/")
```
...
ggsave("./Figures/02/Figure02.pdf", Figure2, width = 7.4, height = 7.4, bg = "white", dpi = 1000)
```
